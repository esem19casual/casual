...
figure <- "D:\\Pesquisa\\replicacao saner\\analise\\contribuicoes_casuais_por_linguagem\\heuristica.eps"
setEPS()
...
##casuais commits
casuais_linguagem <- read_excel("casuais_commits.xls",sheet = "Planilha 19")
figure <- "D:\\Pesquisa\\replicacao saner\\analise\\contribuicoes_casuais_por_linguagem\\commits.eps"
setEPS()
postscript(figure, width = 6, height = 4) #, pointsize = 1/100
